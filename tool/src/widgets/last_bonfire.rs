...
impl LastBonfire {
    fn new(ptr: PointerChain<u32>, warp: BonfireWarp, key_close: Key) -> Self {
        Self {
            ptr,
            warp,
...
impl Widget for LastBonfire {
    fn render(&mut self, ui: &imgui::Ui) {
        ...
        if ui.button_with_size("Bonfires", [button_width, BUTTON_HEIGHT]) {
...
pub(crate) fn last_bonfire(
    ...
    Box::new(LastBonfire::new(ptr, warp, key_close))
}
